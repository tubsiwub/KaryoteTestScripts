...
#region additional (mostly) private variables
    ...
    PostProcessLayer postProcessing2;
...
#endif
#if UNITY_POST_PROCESSING_STACK_V2
            if (postProcessingVolume.profile != underWaterParameters.underwaterProfile2)
            {
                postProcessingVolume.profile = underWaterParameters.underwaterProfile2;
                postProcessingVolume.sharedProfile = underWaterParameters.underwaterProfile2;
            }
#endif
#endregion
...
#if UNITY_POST_PROCESSING_STACK_V2
            if (postProcessingVolume.profile != underWaterParameters.defaultProfile2)
            {
                postProcessingVolume.profile = underWaterParameters.defaultProfile2;
                postProcessingVolume.sharedProfile = underWaterParameters.defaultProfile2;
            }
#endif
#endregion
